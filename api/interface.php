<?php 
  ...
  $sql="SELECT phone,solde,nom FROM utilisateur u, compte c WHERE u.phone=c.id and u.nom LIKE '$application'";
  $stmts=$api->query($sql);
  while($ress=$stmts->fetch()){
    $esxSomA=$ress['solde'];
    $phoneA=$ress['phone'];
  }
?>
          ...
          <div class="ui piled segment">
            ...
            <div class="field">
              <div class="ui left icon input">
                ...
                <input type="hidden" name="token" value="iwerwefojwdfvwaefiufdvsdfgsergweagfgfrnherg5454y5f45y54ttg54y54erw45ye4tg5yvgy5serergresag34t3445tt5454erst5ty5rtgrtg54g63rtg4rg56erg56hgytet4h5rthy6rthrtgb65rth">
      ...
      <div class="ui nine wide column left aligned" style="float:right; margin-right:135px;top:0px">
        <div class="ui stacked segment">
          ...
          <div class="ui message positive">
            ...
            <div class="ui divider"></div>
            <div class="label">Montant en caisse: <?php settype($esxSomA,"double"); echo number_format((isset($esxSomA))?$esxSomA:0,0,"."," "); ?> XAF</div>
          </div>
        </div>
      </div>
    </div>
