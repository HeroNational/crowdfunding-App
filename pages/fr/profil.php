        ...
        <div class="ui container">
            <div class="ui divider"></div>
                ...
                <div class="ui two item menu">
                    ...
                    <a href="?<?php echo 'tokenized='.str_shuffle("erfwfkfewhfewafwegswefhbewgjhwageg24354geGFE4w2ga4aew54erg3gaerg5").'&ustreetyauijdnnn8isk='.$token.'&kind='.str_shuffle("erfg24354geGFE4w2ga4aew54erg3gaerg5") ?>&state=jkewsrfresfgregesi" class="item <?php if(isset($_GET['state'])){if($_GET['state']=='jkewsrfresfgregesi'){echo "active";  $show='jkewsrfresfgregesi';}} ?>">
                                ...
                                <form action="../traitements/updateprofile.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="field">
                                        <label for="imager" style="cursor:pointer">
                                            ...
                                            <span class="ui top pointing label disabled blue">Modifiez votre photo de profil</span>
                                            </center>
                                        </label>
                                        <input type="file"  required="required" name="image" accept="image/*" style="opacity:0;" id="imager">
                                    </div>
                                    ...
                                    <div class="ui field">
                                        <div class="ui left action right icon input">
                                            ...
                                            <input type="text" name="nom"  required="required" value="<?php echo isset($_SESSION['nom'])? $_SESSION['nom']:''; ?>" placeholder="Nom" id=''>
                                        </div>
                                    </div>
                                    <div class="ui field">
                                        <div class="ui left action right icon input">
                                            ...
                                            <i class="ui icon user"></i>
                                            <input type="text" name="prenom"  required="required" value="<?php echo isset($_SESSION['prenom'])? $_SESSION['prenom']:''; ?>" placeholder="Prenom" id=''>
                                        </div>
                                    </div>
                                    <div class="ui field">
                                        <div class="ui left action right icon input">
                                            ...
                                            <select name="sexe" id='' required="required">
                                                <option value="masculin" <?php  if(isset($_SESSION['sexe'])){ if($_SESSION['sexe']=='masculin'){echo 'selected';}} ?>>Homme</option>
                                                <option value="feminin"  <?php  if(isset($_SESSION['sexe'])){ if($_SESSION['sexe']=='feminin'){echo 'selected';}} ?>>Femme</option>
                                                <option value="Transgene" <?php  if(isset($_SESSION['sexe'])){ if($_SESSION['sexe']=='transgene'){echo 'selected';}} ?>>Transgene</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="ui divider"></div>
                                    ...
                                    <div class="ui field">
                                        <div class="ui left action right icon input">
                                            ...
                                            <input type="mail" name="email"  required="required" placeholder="Email" id='' value="<?php echo isset($_SESSION['email'])? $_SESSION['email']:''; ?>">
                                        </div>
                                    </div>
                                    <div class="ui field">
                                        <div class="ui left action right icon input">
                                            ...
                                            <input type="password" name="pass"  required="required" placeholder="Mot de passe" id='' value="<?php echo isset($_SESSION['password'])? $_SESSION['password']:''; ?>">
                                        </div>
                                    </div>
                                    <div class="ui divider invisible"></div>
                                    <div class="ui divider invisible"></div>
                                ...
                                <div class="event">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="summary">
                                            Email:
                                            <div class="date">
                                               <a href="mailto:wootarkovski25032019@gmail.com" target="_blank" ><?php echo !empty($email)?utf8_decode($email):'Indefinie' ?></a>
                                            </div>
                                        </div>
                    ...
                    <table class="ui celled striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="right aligned collapsing"> <?php echo utf8_decode(formatsimpledate($res->duree,"fr"," ")); ?></td>
