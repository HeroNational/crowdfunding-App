    ...
    <header id="header" class="header-lg header-mob header-hideEs">
        <div class="container menu-container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li class="<?php if($index=="index") echo "menu-active"; ?>"><a href="index.php"><span
                                class="lnr lnr-home"></span>&nbsp;&nbsp;Accueil</a></li>
                    <li class="menu-has-children <?php if($index=="financer") echo "menu-active"; ?>"><a href="#"><span
                                class="lnr lnr-rocket"></span class="lnr lnr-rocket">&nbsp;&nbsp;Financer</a>
                        <ul>
                            <li><a href="#">Guide de financement</a></li>
                            <li><a href="campagne.php">Toutes les campagnes</a></li>
                        </ul>
                    </li>
                    <li class="menu-has-children <?php if($index=="projet") echo "menu-active"; ?>"><a href="#"><span
                                class="lnr lnr-briefcase"></span class="lnr lnr-briefcase">&nbsp;&nbsp;Entreprendre</a>
                        <ul>
                            <li><a href="entreprise.php">Guide entreprise</a></li>
                            <li><a href="projet.php">Soumettre un projet</a></li>
                        </ul>
                    </li>
                    <li class="<?php if($index=="blog") echo "menu-active"; ?>"><a href="blog.php"><span
                                class="lnr lnr-link"></span class="lnr lnr-link">&nbsp;&nbsp;Blog</a></li>
                    <li class="<?php if($index=="contact") echo "menu-active"; ?>"><a href="contactus.php"><span
                                class="lnr lnr-phone-handset"></span
                                class="lnr lnr-phone-handset">&nbsp;&nbsp;Contact</a></li>
              ...
              ?>
                    ...
                    <li><a href="inscription.php" class=" myButton ui button"
                            style="margin-top: 5px;background:rgba(224, 114, 11)!important;font-weight:250;color:white;margin-right:-10px;"
                            href="#"><i class="lnr lnr-enter"></i>&nbsp;Inscription</a></li>
                    <li onclick="modalcon()" id="conbtn"><a id="modalCon" class=" myButton ui button"
                            style="margin-top: 5px; background:rgb(4, 166, 180)!important; font-weight:250;color: rgb(255, 255, 255);margin-right:-160px;"><i
                                class="lnr  lnr-enter-down"></i>&nbsp;Connexion</a></li onclick="modalcon()">
                    <?php
                }
              ?>
                </ul>
            ...
            <div class="col-ms-8 col-md-12 col-lg-8" style=" padding-bottom:40px;">
                <div class="ui middle aligned center aligned grid" style="margin-top:25px;">
                    <div class="columnForm column">
                        <a class="lnr lnr-cross" onclick="closemodalcon()" id="closebtn"
                            style="background:transparent; border: 0px; cursor: pointer; color:white; font-size:30px; position:fixed; right:160px;top:50px;"></a>
                        ...
                        <div class="ui message">
                            Vous êtes nouveau? <a href="inscription.php" onclick="closemodalcon(); modallog();"
                                style="letter-spacing:0px;"><span
                                    style="color:rgb(66, 146, 12); font-size:x-large">+</span> Inscription</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div onclick="$(this).slideToggle(100)" data-wow-iteration="infinite" data-wow-duration="1500ms"
    ...
    style="position:fixed;max-width:400px; z-index:100000000000; bottom:60px; right:15px; cursor:default">
    <?php echo $_SESSION['notification_text']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ui close icon"></i>
</div>
<?php
