...
<head>
    ...
    <?php $index="inscription"; include("../../includes/connexionBd.php");
...
<body>
    <section
        class="wow <?php $animationCon=array("slideInLeft","slideInRight","zoomIn","slideInDown","slideInUp"); $animationConN=mt_rand(0,4); echo $animationCon[$animationConN]; ?>">
        <div class="">
            <div class="row">
                    ...
                    <div class="ui middle aligned center aligned grid" style="margin-top:25px;">
                        <div class="columnForm column">
                            <div class="ui stacked segment">
                                ...
                                <form action="../traitements/authentification.php" enctype="multipart/form-data"
                                    ...
                                    <div class="field">
                                        <label for="imager" style="cursor:pointer">
                                            <center style="position:relative">
                                                ...
                                                <img src="../../img/imguser/default.png" alt="Votre photo de profil"
                                                    class="ui image circular"
                                                    style="height:100px; width:100px;border:2px solid teal; padding:0px 1px;">
                                                <span class="ui top pointing label disabled green">Choisissez une photo
                                                    de profil</span>
                                            </center>
                                        </label>
                                    ...
                                    <div class="two fields">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="ui left icon input">
                                                <input type="text" name="nomI" required="required"
                                    ...
                                    <div class="two fields">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="ui left icon input">
                                                <input type="password" name="passwordI" value="" required="required"
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="ui left icon input">
                                                <input type="email" name="emailI" required="required"
                                                    placeholder="E-mail"
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="ui left icon input labeled">
                                            <textarea name="descriptionI" placeholder="En quelques mots parlez de vous."
                                                id=""></textarea>
                                        </div>
                                    </div>
                                ...
                                ?>
                                            <input type="number" name="captcha" required="required"
                                                placeholder="<?php echo $operation ?>">
                                        </div>
                                    </div>
                                    <button type="submit" class="ui fluid large green submit button">Inscription
                                    </button>
                                    <style>
                            ...
                            <div class="ui message">
                                Déjà un compte? <a href="connexion.php" onclick="closemodallog();modalcon(); "
                                    style="letter-spacing:0px;"><span
                                        style="color:rgb(66, 146, 12); font-size:x-large">+</span> Connexion</a>
                            </div>
                        </div>
                    </div>
                </div>
