                ...
                <center style="position:relative;top:-4px">
                    ...
                    <span class="hidden content">
                        <span class='lnr lnr-users'
                            style="font-Weight:bold;font-Size:19px; position:relative; top:4px"></span>
                    </span>
                </center>
            </a>
        </div>
                    ...
                    <div class="three wide column">
                        <div class="ui link list">
                            ...
                            <a href="#" class="item"><span
                                    class="lnr lnr-phone-handset"></span>&nbsp;&nbsp;Telephone:+237
                                657675216</a>
                            <a href="#" class="item"><span class="socicon-whatsapp"></span>&nbsp;&nbsp;+237
                                657675216</a>
                            <a href="contactus.php" class="item"><span class="socicon-internet"></span>&nbsp;&nbsp;Via
                                le site web</a>

                            <a href="#" class="item"><span class="socicon-mailru"></span>&nbsp;&nbsp;Email:
                                funding@abodah.com</a>
                            <a href="#" class="item"><span class="lnr lnr-inbox"></span>&nbsp;&nbsp;Boite postale: 2345
                                Yde</a>
...
<div id="scrollshow"
    style=" background: rgb(34,195,107);background: radial-gradient(circle, rgba(34,195,107,1) 0%, rgba(34,193,195,1) 40%, rgba(117,183,191,1) 52%, rgba(253,187,45,1) 100%); position: fixed; left:0; top:0px;z-index: 2000000; height: 4px;">
</div>
<script>
    ...
    window.addEventListener("scroll", () => {
        ...
        scrollPercentRounded = Math.round(scrollPercent * 100) - 2
        if (Math.round(scrollPercent * 100) - 2 > 100) {
            scrollPercentRounded = 100;
        } else {
            if (Math.round(scrollPercent * 100) - 2 < 0) {
                scrollPercentRounded = 0;
            }
        }
        document.title = docT + " : " + scrollPercentRounded + "% de la lecture"
        //percentLabel.innerHTML = scrollPercentRounded;
        document.getElementById("scrollshow").style.width = scrollPercentRounded + "%";
    });
</script>
