...
-- Listage de la structure de la base pour abodah
DROP DATABASE IF EXISTS `abodah`;
CREATE DATABASE IF NOT EXISTS `abodah` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `abodah`;

-- Listage de la structure de la table abodah. administrateur
...
-- Listage des données de la table abodah.administrateur : ~1 rows (environ)
/*!40000 ALTER TABLE `administrateur` DISABLE KEYS */;
INSERT INTO `administrateur` (`idad`, `login`, `password`) VALUES
	(1, 'default', 'default');
/*!40000 ALTER TABLE `administrateur` ENABLE KEYS */;

-- Listage de la structure de la table abodah. anonyme
DROP TABLE IF EXISTS `anonyme`;
CREATE TABLE IF NOT EXISTS `anonyme` (
...
-- Listage des données de la table abodah.anonyme : ~2 rows (environ)
/*!40000 ALTER TABLE `anonyme` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `anonyme` ENABLE KEYS */;

-- Listage de la structure de la table abodah. appreciation
...
-- Listage des données de la table abodah.appreciation : ~0 rows (environ)
/*!40000 ALTER TABLE `appreciation` DISABLE KEYS */;
/*!40000 ALTER TABLE `appreciation` ENABLE KEYS */;

-- Listage de la structure de la table abodah. article
...
-- Listage des données de la table abodah.article : ~0 rows (environ)
/*!40000 ALTER TABLE `article` DISABLE KEYS */;
/*!40000 ALTER TABLE `article` ENABLE KEYS */;

-- Listage de la structure de la table abodah. categorie
...
-- Listage des données de la table abodah.categorie : ~4 rows (environ)
...
-- Listage de la structure de la table abodah. financement
...
-- Listage des données de la table abodah.financement : ~17 rows (environ)
...
-- Listage de la structure de la table abodah. internaute
...
-- Listage des données de la table abodah.internaute : ~14 rows (environ)
...
-- Listage de la structure de la table abodah. message
...
-- Listage des données de la table abodah.message : ~20 rows (environ)
...
-- Listage de la structure de la table abodah. newsletter
...
-- Listage des données de la table abodah.newsletter : ~7 rows (environ)
...
-- Listage de la structure de la table abodah. projet
...
-- Listage des données de la table abodah.projet : ~10 rows (environ)
...
-- Listage de la structure de la table abodah. reunion
...
-- Listage des données de la table abodah.reunion : ~0 rows (environ)
