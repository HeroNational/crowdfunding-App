            ...
            if($_POST['montant']>0){
                ...
                if($value['status']=="success"){
                    ...
                    if($bdd->query($sql)){
                        ...
                        $messager=isset($value['message'])?$value['message']:'ergye';
                        $_SESSION['notification_text']="😱😒 Nous n'avons pas pu terminer l'action a cause de l'erreur ' ".$messager." '. Consulter votre banquier ou reessayez.";
                        $_SESSION['notification']=true;
