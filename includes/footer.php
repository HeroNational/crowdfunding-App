...
<div class=" wow slideInUp /zoomIn">
  ...
  <section>
      ...
      <div class="ui  vertical footer segment" style="background:rgba(0,0,0,0.01)!important;">
          <div style="padding-left:10px;padding-Right:10px" >
              <div class="ui stackable divided equal height stackable grid">
                  <div class="three wide column">
                      <h3 class="item"><span style="color:teal;font-size:20px">Abodah</span>&nbsp; <span style="color:#d08421;font-size:25px;font-weight:bold">Funding</span></h3>
              ...
              <div class="ui stackable grid center aligned" style="background:rgba(71,83,92,0.1)">
                  <div class="sixteen column wide">
                          &copy; Abodah Corporation 2016 - <script>document.write(new Date().getFullYear());</script>
                  </div>
              </div>
          </div>
      </div>
